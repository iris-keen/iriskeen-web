        ...
        <div className="mx-auto flex w-full max-w-7xl justify-center md:justify-start px-6 md:px-20">
          <div className="w-full max-w-[560px] pt-16 md:pt-32">
            ...
            <div className="mt-8 flex flex-col md:flex-row gap-4 md:gap-5 w-[85%] md:w-auto mx-auto md:mx-0">
              ...
              <a
                href="#hotels"
                className="rounded-full border border-white/30 bg-white/5 px-7 md:px-10 py-3.5 md:py-4 text-base md:text-lg text-white text-center backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-white/60 hover:bg-white/10"
              >
                استكشف الفنادق
              </a>
